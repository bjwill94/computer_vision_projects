...
class SnakeGameClass:
    ...
    def update(self, imgMain, currentHead):
        ...
        if self.gameOver:
            ...
            cvzone.putTextRect(imgMain,f'Your Score:{self.score} ',[300,550],scale=7
                               ,thickness=5,offset=20)
        else:
...
while True:
    ...
    if hands:
        lmList = hands[0]['lmList']#landmark List of the hand detected
        pointIndex = lmList[8][0:2] #lmList gives 3 values x,y,z .We only need x and y coordinates
